...
func (proc *Proc) KubeStateMetricFilter(fqName string) bool {
	...
	// Job
	case ksm.KsmFqNameJobLabels:
	case ksm.KsmFqNameJobInfo:
	case ksm.KsmFqNameJobCreated:
	case ksm.KsmFqNameJobSpecParallelism:
	case ksm.KsmFqNameJobSpecCompletions:
	case ksm.KsmFqNameJobSpecActiveDeadlineSeconds:
	case ksm.KsmFqNameJobStatusSucceeded:
	case ksm.KsmFqNameJobStatusFailed:
	case ksm.KsmFqNameJobStatusActive:
	case ksm.KsmFqNameJobComplete:
	case ksm.KsmFqNameJobFailed:
	case ksm.KsmFqNameJobStatusStartTime:
	case ksm.KsmFqNameJobStatusCompletionTime:
	case ksm.KsmFqNameJobOwner:
	// PVC
	...
	case ksm.KsmFqNamePodInitContainerStatusWaitingReason:
	case ksm.KsmFqNamePodInitContainerStatusRunning:
	case ksm.KsmFqNamePodInitContainerStatusTerminated:
	case ksm.KsmFqNamePodInitContainerStatusTerminatedReason:
	case ksm.KsmFqNamePodInitContainerStatusLastTerminatedReason:
	case ksm.KsmFqNamePodInitContainerStatusReady:
	case ksm.KsmFqNamePodInitContainerStatusRestartsTotal:
	...
	// ResourceQuota
	case ksm.KsmFqNameResourcequotaCreated:
	case ksm.KsmFqNameResourcequota:
	// Secret
	...
	// Storageclass
	case ksm.KsmFqNameStorageclassInfo:
	case ksm.KsmFqNameStorageclassCreated:
	case ksm.KsmFqNameStorageclassLabels:
